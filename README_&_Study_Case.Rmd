---
tittle: rOceans package - rOceansData package & Study Case
author: I. Montero-Serra
date: 30/Jul/2018
output: html_document
---

# rOceans - Google Summer Code 2018 

This file describes the recently developed rOceans package and the datapackage rOceansData and contains a comprehensive study case. The project has been lead by Ignasi Montero-Serra and fundend by Google within the program Google Summer Code 2018.  
...
rOceansData is an R DataPackage that contains several marine biodiversity layers and environmental drivers to make easy explorations using rOceans. 
