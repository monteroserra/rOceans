...
abundance_0.5 = oceanAbundance(occurrences = Acropora_Total_Checked, cell_size=0.5)
```
...
Grid cells of 0.5º lat x 0.5º long
```{r}
oceanMaps(abundance_0.5, logScale=T, main="Sharks abundance (0.5x0.5)")
```
